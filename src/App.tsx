...
const ServiceCard = ({ icon: Icon, title, description, features }: ServiceCardProps) => (
  <div className={`group relative backdrop-blur-xl border rounded-2xl sm:rounded-3xl p-5 sm:p-8 hover:border-red-500/40 transition-all duration-500 overflow-hidden ${
...
const ProjectCard = ({ title, subtitle, description, tags, icon: Icon, gradient, featured }: ProjectCardProps) => (
  <div className={`group relative backdrop-blur-xl border rounded-2xl sm:rounded-3xl overflow-hidden hover:border-red-500/40 transition-all duration-500 ${
...
// Discord Webhook URL
const DISCORD_WEBHOOK_URL = 'https://discord.com/api/webhooks/1510318451892424844/PgGqcSw5WxhS9ThJV-d2n-x5IhzXw8gM5cNCUNyOzac4s_FBE4z-aQbHS6gSAXST8Wtx';
const PORTFOLIO_URL = 'https://vqeoic3pbjbs.space.minimax.io';
        ...
        embeds: [
          {
            author: {
              ...
              url: PORTFOLIO_URL,
              icon_url: `${PORTFOLIO_URL}/profile.jpg`,
            },
            title: '━━━━━━━━━━━━━━━',
...
function App() {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-black' : 'bg-gray-50'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'} overflow-x-hidden`}>
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen flex flex-col justify-center relative pt-20 sm:pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 lg:py-16 grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative z-10 flex-1 w-full">
          {/* Text Content */}
          <div className="space-y-4 sm:space-y-6 lg:space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/[0.03] border border-white/[0.06] rounded-full text-xs sm:text-sm">
              <Sparkles size={14} className="sm:text-base text-red-400" />
              {t.welcome}
            </div>
            <h1 className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black leading-tight">
              <span>I am </span>
            ...
            <p className="text-sm sm:text-base lg:text-lg leading-relaxed max-w-lg mx-auto lg:mx-0">
              {t.description}
            </p>
          ...
          {/* Avatar & Badges */}
          <div className="flex flex-col items-center lg:items-end gap-4 sm:gap-6 lg:gap-8">
            {/* Avatar with Profile Image */}
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-red-600 to-red-500 rounded-full blur-3xl opacity-20" />
              <div className="relative w-36 h-36 xs:w-44 xs:h-44 sm:w-52 sm:h-52 md:w-60 md:h-60 lg:w-64 lg:h-64 rounded-full p-0.5 bg-gradient-to-br from-red-600 to-red-500">
              ...
              {/* Glow Ring */}
              <div className="absolute inset-2 sm:inset-3 rounded-full border-2 border-red-500/20 animate-pulse" />
            </div>
